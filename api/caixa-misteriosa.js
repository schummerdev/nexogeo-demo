        ...
        if (existingParticipantResult.rows.length > 0) {
            ...
            try {
                const updateResult = await query(
                    'UPDATE public_participants SET name = $1, neighborhood = $2, city = $3 WHERE id = $4 RETURNING id',
                    [name, neighborhood, city, participant.id]
                );
            ...
            console.log('🔄 Participante atualizado:', { id: participant.id, name });
